...
########################################################################################
###                                                                                  ###
###                 R script for Human Penguin Project (Mturk)                       ###
...
###                                                                                  ###
###  Purpose:                                                                        ###
###  Pre-processing the plit data  from Amazon Mechanical Turkas reported            ### 
...
###                'Core_Temperature_Study__Improved_MTurk total.sav'                ###
###      Revised data:'Data_Raw_HPP_Pilot_MT_Share.csv', by Ji-Xing Yin              ###
###                                                                                  ###
###  Output file and Variables:                                                      ###
###     'Data_Sum_HPP_Pilot_MT_Share.csv'                                            ###
###     'Data_Sum_HPP_Pilot_All_Share.csv'                                           ###
###                                                                                  ###
########################################################################################
########################################################################################
...
#### Load data
data <- read.csv("Data_Raw_HPP_Pilot_MT_Share.csv", header = TRUE,sep = ',', stringsAsFactors=FALSE,na.strings=c(""," ","NA"))
...
write.csv(pilotSum_reord,'Data_Sum_HPP_Pilot_MT_Share.csv',row.names = F)
...
pilotData_reord <- rbind(pilotPA_reord,pilotSum)
