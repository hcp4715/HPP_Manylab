...
#
# Preprocessed data: 'Data_Raw_HPP_Pilot_PA_Share.csv' (with codebook 'Codebook_HPP_PA_Share_201808.xlsx')
...
# print the omega-hierarchical and omega_total
print(c(scontrolOmega$omega_h,scontrolOmega$omega.tot)) # 0.6127
